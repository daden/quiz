        ...
        return {
            link: function (scope,element,attrs) {
                ...
                $rootScope.hideLoading = function() {
                    $('body').find("#loadingScreen").remove();
                }
            }
        }
    }
